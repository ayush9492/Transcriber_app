...
lottie_animation_1='https://assets8.lottiefiles.com/packages/lf20_nmrwmvic.json'
lottie_anime_json = load_lottieurl(lottie_animation_1)
st.title('Welcome to Transcription app 📝!')
st_lottie(lottie_anime_json,key='transcribe')
...
# The App
#page = st.sidebar.selectbox("Live Transcription")
